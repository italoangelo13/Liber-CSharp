...
*/
    ...
    function verificarTelefone(telefone) {
        var telText = telefone.value.replace(/[^\d]/g, '');
        var textboxid = telefone.id;
        if (telText.length < 10) {

            if (telText.length == 0)
                document.getElementById(textboxid).value = "(00) 0000-0000";
...
/*Data Corrente*/
    function carregaData(textbox) {
        ...
        var mes = dataatual.getMonth().toString.length == 1 ? '0' + (dataatual.getMonth() + 1) : dataatual.getMonth();
    ...
    /*Função que padroniza telefone (11) 4184-1241 Mascara Antiga*/
    //function Telefone(v){
    //    v=v.replace(/\D/g,"")                 
...
function VerificarCns(cnsParametro)
{
    ...
    var tamCNS = cns.length;
            if ((tamCNS) != 15) {
                ...
                document.getElementById("_edCNES").value = "";
		        document.getElementById("_edCNES").focus();
		        return false;
	        }
    }
